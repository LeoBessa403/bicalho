				...
				<section id="our-team">
					...
					<ul class="team-members list-unstyled">
						...
						<li class="team-member">
							<img src="<?php echo PASTASITE; ?>images/team/1.jpg" alt="" class="profile-pic img-responsive">
							<div class="profile">
						...
						<li class="team-member">
							<img src="<?php echo PASTASITE; ?>images/team/2.jpg" alt="" class="profile-pic img-responsive">
							<div class="profile">
	...
	<section id="our-clients" class="row inner-sm">
		<div class="container">
			...
			<ul class="list-unstyled row list-clients">
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/brands/brand-01.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/brands/brand-02.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/brands/brand-03.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/brands/brand-04.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/brands/brand-01.jpg" /></a></li>
				<li class="col-md-2"><a href="#"><img alt="" src="<?php echo PASTASITE; ?>images/brands/brand-02.jpg" /></a></li>
			</ul>
		</div>
