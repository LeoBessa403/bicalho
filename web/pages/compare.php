                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="image-wrap">
                                ...
                                <img width="220" height="154" alt="Iconia W700" class="attachment-yith-woocompare-image" src="<?php echo PASTASITE; ?>images/products/product-01.jpg">                        
                            </div>
                        ...
                        <td class="text-center">
                            <div class="image-wrap">
                                ...
                                <img width="220" height="154" alt="POV Action Cam" class="attachment-yith-woocompare-image" src="<?php echo PASTASITE; ?>images/products/product-02.jpg">                        
                            </div>
                        ...
                        <td class="text-center">
                            <div class="image-wrap">
                                ...
                                <img width="220" height="154" alt="PlayStation 4" class="attachment-yith-woocompare-image" src="<?php echo PASTASITE; ?>images/products/product-03.jpg">                        
                            </div>
                        ...
                        <td class="text-center">
                            <div class="image-wrap">
                                ...
                                <img width="220" height="154" alt="Cyber-shot Digital Camera WX300" class="attachment-yith-woocompare-image" src="<?php echo PASTASITE; ?>images/products/product-04.jpg">                       
                            </div>
                    ...
                    <tr class="tr-add-to-cart">
                        ...
                        <td class="text-center">
                            <div class="add-cart-button">
                                <a class="le-button add_to_cart_button  product_type_simple" href="index.php?page=cart">add ao carrinho</a>
                            </div>                    
                        </td>
                        <td class="text-center">
                            <div class="add-cart-button">
                        ...
                        <td class="text-center">
                            <div class="add-cart-button">
                                <a class="le-button add_to_cart_button  product_type_variable" href="index.php?page=cart">add ao carrinho</a>
                            </div>                    
                        </td>
                    </tr>
                </thead>
