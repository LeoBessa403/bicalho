...
<div class="widget accordion-widget category-accordions">
    ...
    <div id="accordion" class="accordion">
        ...
        <div class="accordion-group">
            <div class="accordion-heading">
                <a class="accordion-toggle collapsed" data-toggle="collapse"  href="#collapse3" data-parent="#accordion">
                    laptops
                </a>
            </div>
        ...
        <div class="accordion-group">
            <div class="accordion-heading">
                <a class="accordion-toggle collapsed" data-toggle="collapse"  href="#collapse4" data-parent="#accordion">
                    notebooks
                </a>
            </div>
