        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6 banner">
                <a href="index.php?page=category-grid-2">
                    ...
                    <img class="banner-image img-responsive" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/banner-narrow-01.jpg" />
                </a>
            </div>
            <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6 text-right banner">
                <a href="index.php?page=category-grid-2">
                    ...
                    <img class="banner-image img-responsive" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/banner-narrow-02.jpg" />
                </a>
            </div>
        </div>
    </div><!-- /.container -->
